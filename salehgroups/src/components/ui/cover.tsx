...
export const Cover = ({
  ...
  }, []); // fixed: removed ref.current from dependency array
  ...
  return (
    <div
      ...
      ref={ref}
      className="relative group/cover inline-block px-2 py-2 transition duration-200 rounded-sm hover:bg-neutral-900 dark:hover:bg-neutral-900"
    >
      <AnimatePresence>
        {hovered && (
          <motion.div
